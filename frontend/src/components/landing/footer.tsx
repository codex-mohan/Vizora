...
export function Footer() {
  return (
    <footer className="relative overflow-hidden bg-[#080a08] pb-0">
      <div className="pointer-events-none absolute inset-x-0 bottom-0 h-80 bg-gradient-to-t from-cyan-400/10 via-cyan-400/5 to-transparent blur-3xl" />
      ...
      <div className="relative mx-auto max-w-7xl px-5 pt-12 sm:px-8">
        <div className="mb-10 flex flex-col items-center gap-4 sm:mb-16 sm:flex-row sm:justify-between">
          ...
          <div className="flex items-center gap-2.5">
            <div className="grid size-8 place-items-center rounded-lg bg-cyan-400/10 text-cyan-400">
